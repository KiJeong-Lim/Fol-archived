...
Furthermore, to facilitate the translation of mathematical results, Leibniz equality $\Leq$ with its introduction and elimination rules is provided, and also the quantifiers in the system under this study bind named individual variables---that is, individual variables are not represented by de Bruijn indices.
...
However, there are no known works that give Leibniz equality and named quantifiers and allow users to assume an infinite number of axioms at the same time.
